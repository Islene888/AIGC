    ...
    with engine.connect() as conn:
        for i in range((end_date - start_date).days + 1):
            ...
            SELECT * FROM (
              ...
              WHERE a.event_date = '{date_str}'
                AND a.workflow IS NOT NULL
                AND a.workflow != ''
...
if __name__ == "__main__":
    insert_click_rate_compare(start_date_str="2025-04-16", end_date_str="2025-05-12")